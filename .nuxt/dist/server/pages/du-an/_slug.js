...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._ssrNode("<div class=\"title \"><h3 class=\"text-16 fw-600 main-black mb-0 pl-24px\">\n            Thông tin khách hàng\n        </h3> <hr class=\"hr my-15px\"></div> <section id=\"infor-component\" class=\"custom-customer\"><div class=\"cover-img mt-20px \""+(_vm._ssrStyle(null,{
                ...
                }, null))+"><div class=\"stt custom fw-500 text-center\"><p class=\"f-12 w-100\"><img"+(_vm._ssrAttr("src",__webpack_require__(180)))+" class=\"mb-2px\">"+_vm._ssrEscape("\n                    "+_vm._s(_vm.detailAccount.name)+"\n                ")+"</p></div></div> <div class=\"group-star d-flex mt-20px mb-20px\"><div class=\"star-number mr-4px\"><p class=\"f-10\">5.0</p></div> "+(_vm._ssrList((5),function(item,idx){return ("<div><i class=\"fas fa-star mr-1px f-13\"></i></div>")}))+" <p class=\"evaluate f-12 mb-0 mt-5px ml-4px\">(<span>5</span>  đánh giá)</p></div> "+((_vm.$auth.loggedIn)?("<p class=\"mb-0 f-13 mb-15px\">Bạn sẽ tốn <span class=\"text-main fw-600\">3 Tokens</span> khi liên hệ trực tiếp với khách đăng tin</p> <div class=\"btn-contact d-block mb-0 cursor-pointer\"><span><img"+(_vm._ssrAttr("src",__webpack_require__(101)))+" class=\"mb-3px\">\n                    Liên hệ trực tiếp\n                </span></div>"):"<!---->")+"</section> "),_c('PopupLienhe',{ref:"refLienHe"})],2)}
var staticRenderFns = []
