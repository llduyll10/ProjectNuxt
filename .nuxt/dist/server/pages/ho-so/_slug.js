exports.ids = [71,16,24,25,37,49,60,64,65];
exports.modules = {
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return (_vm.profile)?_c('section',{attrs:{"id":"infor-component"}},[_vm._ssrNode("<div class=\"cover-img\""+(_vm._ssrStyle(null,{
            ...
            }, null))+"><div class=\"stt\"><p class=\"f-11\"><img"+(_vm._ssrAttr("src",__webpack_require__(183)))+" class=\"pb-5px\">"+_vm._ssrEscape(" "+_vm._s(_vm.profile.province))+"</p></div></div> <div class=\"group-star d-flex mt-20px mb-20px\"><div class=\"star-number mr-4px\"><p class=\"f-10\">5.0</p></div> "+(_vm._ssrList((5),function(item,idx){return ("<div><i class=\"fas fa-star mr-1px f-13\"></i></div>")}))+" <p class=\"evaluate f-12 mb-0 mt-5px ml-4px\">(<span>5</span>  đánh giá)</p></div> "),(_vm.$auth.loggedIn)?[(_vm.$auth.user && _vm.$auth.user._id == _vm.profile._id)?_c('nuxt-link',{staticClass:"btn-contact",attrs:{"prefetch":false,"to":"/member/chinh-sua-ho-so?tab=1"}},[_c('span',[_c('img',{staticClass:"mb-5px",attrs:{"src":__webpack_require__(90)}}),_vm._v("\n                Cập nhật hồ sơ\n            ")])]):[_c('button',{staticClass:"btn-contact cursor-pointer",on:{"click":_vm.openLienHe}},[_c('span',[_c('img',{staticClass:"mb-3px",attrs:{"src":__webpack_require__(101)}}),_vm._v("\n                    Liên hệ trực tiếp\n                ")])]),_vm._v(" "),_c('button',{staticClass:"btn-contact email",on:{"click":_vm.openLienHeMail}},[_c('span',[_c('img',{staticClass:"mb-5px",attrs:{"src":__webpack_require__(135)}}),_vm._v("\n                    Gửi tin nhắn\n                ")])])]]:_vm._ssrNode("<button class=\"btn-contact cursor-pointer\"><img"+(_vm._ssrAttr("src",__webpack_require__(101)))+"> <span>Liên hệ trực tiếp</span></button> <button class=\"btn-contact email\"><img"+(_vm._ssrAttr("src",__webpack_require__(135)))+"> <span>Gửi tin nhắn</span></button>"),_vm._ssrNode(" "),_c('PopupLienhe',{ref:"refLienHe"}),_vm._ssrNode(" "),_c('PopupLienheform',{ref:"LienHeFormPop"})],2):_vm._e()}
var staticRenderFns = []
...
var longb = __webpack_require__(97);
...
/* nuxt-component-imports */
installComponents(component, {PopupLienhe: __webpack_require__(95).default,PopupLienheform: __webpack_require__(91).default})
...
/* nuxt-component-imports */
installComponents(component, {Header: __webpack_require__(11).default,ProfileInfo: __webpack_require__(208).default,ProfileDes: __webpack_require__(209).default,ProfileProject: __webpack_require__(210).default,ProfileRating: __webpack_require__(215).default,Footer: __webpack_require__(7).default})
