...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('Header'),_vm._ssrNode(" "),_vm._ssrNode("<section id=\"project\" class=\"pt-30px pb-80px\">","</section>",[_vm._ssrNode("<div class=\"container-fluid\">","</div>",[_vm._ssrNode("<div class=\"row\">","</div>",[_vm._ssrNode("<div class=\"col-lg-3 col-md-3 col-sm-12 pr-10px\"><div class=\"left\"><div class=\"top\"><div class=\"title f-16\">\n                                LĨNH VỰC CÔNG VIỆC\n                            </div></div> <div class=\"line\"></div> <div class=\"list\"><div"+(_vm._ssrClass("d-flex item-title f-14 cursor-pointer",_vm.activeParent == 1 ? 'fw-600 text-main' :''))+">"+((_vm.activeParent == 1)?("<img"+(_vm._ssrAttr("src",__webpack_require__(121)))+" alt>"):("<img"+(_vm._ssrAttr("src",__webpack_require__(167)))+" alt>"))+" <span class=\"build\">"+_vm._ssrEscape(_vm._s(_vm.objCategory[0].label))+"</span></div> <div class=\"list-item f-13\"><ul>"+(_vm._ssrList((_vm.objCategory[0].children),function(item){return ("<li"+(_vm._ssrClass("cursor-pointer",item.active ? 'fw-600 text-main' :''))+">"+_vm._ssrEscape("\n                                        "+_vm._s(item.label)+"\n                                    ")+"</li>")}))+"</ul></div></div> <div class=\"list\"><div"+(_vm._ssrClass("d-flex item-title f-14 cursor-pointer",_vm.activeParent == 2 ? 'fw-600 colorOrange' :''))+">"+((_vm.activeParent == 2)?("<img"+(_vm._ssrAttr("src",__webpack_require__(122)))+" alt>"):("<img"+(_vm._ssrAttr("src",__webpack_require__(168)))+" alt>"))+" <span class=\"decord\">"+_vm._ssrEscape(_vm._s(_vm.objCategory[1].label))+"</span></div> <div class=\"list-item f-13\"><ul>"+(_vm._ssrList((_vm.objCategory[1].children),function(item){return ("<li"+(_vm._ssrClass("cursor-pointer decord",item.active ? 'fw-600 colorOrange' :''))+">"+_vm._ssrEscape("\n                                        "+_vm._s(item.label)+"\n                                    ")+"</li>")}))+"</ul></div></div> <div class=\"list\"><div"+(_vm._ssrClass("d-flex item-title f-14 cursor-pointer",_vm.activeParent == 3 ? 'fw-600 colorGreen' :''))+">"+((_vm.activeParent == 3)?("<img"+(_vm._ssrAttr("src",__webpack_require__(123)))+" alt>"):("<img"+(_vm._ssrAttr("src",__webpack_require__(169)))+" alt>"))+" <span class=\"desgin\">"+_vm._ssrEscape(_vm._s(_vm.objCategory[2].label))+"</span></div> <div class=\"list-item f-13\"><ul>"+(_vm._ssrList((_vm.objCategory[2].children),function(item){return ("<li"+(_vm._ssrClass("cursor-pointer desgin",item.active ? 'fw-600 colorGreen' :''))+">"+_vm._ssrEscape("\n                                        "+_vm._s(item.label)+"\n                                    ")+"</li>")}))+"</ul></div></div></div> <div class=\"box-title\"><p class=\"title f-16\">Tin Tức &amp; Thị Trường</p> <div class=\"line\"></div></div> <div class=\"row\">"+(_vm._ssrList((2),function(item,i){return ("<div class=\"col-md-12 col-sm-6\"><div class=\"left mt-24px\"><div class=\"boxs\"><img"+(_vm._ssrAttr("src",__webpack_require__(124)))+" alt> <h3 class=\"mt-15px\">Bỏ túi ngay bí quyết trang trí phòng khách hiện đại với Phố Xinh </h3> <div class=\"evaluate mt-15px\"><div class=\"lefts\"><img"+(_vm._ssrAttr("src",__webpack_require__(125)))+" alt> <div class=\"text\">\n                                            Bởi <span>Longb04</span></div></div> <div class=\"rights\"><div class=\"one mr-15px\"><img"+(_vm._ssrAttr("src",__webpack_require__(126)))+" alt> <p class=\"ml-6px\">290</p></div> <div class=\"one\"><img"+(_vm._ssrAttr("src",__webpack_require__(127)))+" alt class=\"mb-4px\"> <p class=\"ml-6px\">20</p></div></div></div></div></div></div>")}))+"</div></div> "),_vm._ssrNode("<div class=\"col-lg-9 col-md-9 col-sm-12 pl-10px\">","</div>",[_vm._ssrNode("<div class=\"right margin-top\">","</div>",[_vm._ssrNode("<div class=\"top top-change\">","</div>",[_vm._ssrNode("<div class=\"search-top short-input\"><input type=\"text\" placeholder=\"Tìm kiếm  dự án\""+(_vm._ssrAttr("value",(_vm.objProject.s)))+" class=\"f-12\"></div> "),_c('treeselect',{staticClass:"search-center",attrs:{"options":_vm.optionsProvince,"value":_vm.objProject.address,"placeholder":"Tỉnh thành","clearable":false},model:{value:(_vm.objProject.address),callback:function ($$v) {_vm.$set(_vm.objProject, "address", $$v)},expression:"objProject.address"}}),_vm._ssrNode(" "),_c('treeselect',{staticClass:"search-center range-time",attrs:{"options":_vm.objDateFilter,"value":_vm.objProject.rangeDate,"placeholder":"Thời gian","clearable":false},model:{value:(_vm.objProject.rangeDate),callback:function ($$v) {_vm.$set(_vm.objProject, "rangeDate", $$v)},expression:"objProject.rangeDate"}}),_vm._ssrNode(" <div class=\"button\">Tìm kiếm</div>")],2),_vm._ssrNode(" <div class=\"line\"></div> "+(_vm._ssrList((_vm.listProject),function(item,idx){return ("<div class=\"center mb-20px\"><div class=\"boxinfo \"><div class=\"row\"><div class=\"col-lg-12 col-md-12 col-sm-12\"><div class=\"introduce\"><div class=\"cover-img\""+(_vm._ssrStyle(null,{
                                                    'background-image': 'url(' + "" + (item.photos[0] ? item.photos[0] : _vm.noAvatar) + ')',
                                                }, null))+"><div class=\"one d-flex f-12 cursor-pointer\"><img"+(_vm._ssrAttr("src",__webpack_require__(234)))+" alt> <div class=\"human-name ml-5px f-12\">"+_vm._ssrEscape(_vm._s(item.createBy.name))+"</div></div></div> <div class=\"content nopadding rent\"><div class=\"title d-flex\"><div class=\"d-flex title-icon\"><img width=\"20px\" height=\"20px\""+(_vm._ssrAttr("src",_vm.getIconImg(_vm.mapImgFromCategory(item.category))))+"> <div"+(_vm._ssrClass("sub f-14 text-main cursor-pointer",_vm.getClassCategory(_vm.mapImgFromCategory(item.category))))+">"+_vm._ssrEscape("\n                                                            "+_vm._s(item.name)+"\n                                                        ")+"</div></div> <div class=\"icon\"><img"+(_vm._ssrAttr("src",__webpack_require__(86)))+" alt> <span class=\"name f-11 text-main\">"+_vm._ssrEscape(_vm._s(item.address))+"</span></div></div> <div class=\"description padding-right f-13\">"+_vm._ssrEscape(_vm._s(item.description))+"</div> <div class=\"group-bot d-flex\"><div class=\"group-2 d-flex\"><div class=\"two\">\n                                                            Ngày đăng - <span>"+_vm._ssrEscape(_vm._s(_vm.checkIsToday(item.createdDate)))+"</span></div> <div class=\"three\">\n                                                            Ngân sách - <span>"+_vm._ssrEscape(_vm._s(_vm.formatNamePrice(item.budget)))+"</span></div> <div class=\"four\">\n                                                            Hạn chót chào giá -\n                                                            <span"+(_vm._ssrClass(null,_vm.checkStatusDueDate(item.dueDate) ? 'text-red' :''))+">"+_vm._ssrEscape("\n                                                                "+_vm._s(_vm.checkDueDate(item.dueDate))+"\n                                                            ")+"</span></div></div> <div class=\"like f-13\">"+_vm._ssrEscape("\n                                                        "+_vm._s(item.auctionCount)+" ")+"<span>Chào giá </span></div></div></div></div></div></div></div> <div class=\"line\"></div></div>")}))+" "),(_vm.count>0)?[_c('Pagination',{attrs:{"count":_vm.count,"perPage":5},on:{"page":_vm.getPaging}})]:_vm._e()],2)])],2)])]),_vm._ssrNode(" "),_c('Footer')],2)}
var staticRenderFns = []
...
var icon_decord_orange = __webpack_require__(122);
...
var icon_pen_green = __webpack_require__(123);
...
installComponents(component, {Header: __webpack_require__(11).default,Pagination: __webpack_require__(137).default,Footer: __webpack_require__(7).default})
